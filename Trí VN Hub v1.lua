...
local Window = OrionLib:MakeWindow({Name = "Trí Vn Hub v1", HidePremium = false, IntroText = "Trí Vn Hub v1", SaveConfig = true, ConfigFolder = "Trí Vn Hub v1"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Tap Information",
